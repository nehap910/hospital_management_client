<div
class="relative mx-12 w-full max-w-md px-1 pt-10 pb-8  ">
<div class="w-full">
    ...
    <div class="mt-5">
        <form action="">
            <div class="relative mt-6">
                <input type="email" name="email" id="email" placeholder="Email Address" class="peer mt-1 w-full -300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none bg-transparent " autocomplete="NA" />
